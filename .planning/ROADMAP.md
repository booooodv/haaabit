...
- ✅ **v1.7 OpenClaw Native Plugin** — Phases 26-29, 11/11 plans complete, shipped and archived 2026-03-11.
  Archive:
...
Use `$gsd-new-milestone` to define the next milestone and recreate `.planning/REQUIREMENTS.md`.
